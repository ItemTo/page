...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(22, 25, 29),     -- Dunklerer bläulicher Grauton
			Second = Color3.fromRGB(28, 31, 35),   -- Dunklerer aber etwas hellerer bläulicher Grauton
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Starting Vortex"
	...
	local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		SetChildren(SetProps(MakeElement("TFrame"), {
			...
			AddThemeObject(SetProps(MakeElement("Label", "Vortex", WindowConfig.HidePremium and 14 or 13), {
